...
namespace FMS.Data.Services
{
    public static class FleetServiceSeeder
    {
        ...
        public static void Seed(IFleetService svc)
        {
            ...
            //Add vehicle
            var check = svc.AddVehicle("Toyota", "Camry", 2020, "4444555UY", "Petrol", "Manual", 330, 4, Convert.ToDateTime("2020-09-29"), "https://th.bing.com/th/id/R.1ccc5e38e2df2cad5b3a506b4577ddd4?rik=BtrULevOZ2a1lw&pid=ImgRaw&r=0");
            var check1 = svc.AddVehicle("Volkswagen", "Golf", 2009, "84456721QW", "Diesel", "Auto", 220, 4, Convert.ToDateTime("2020-09-29"), "https://th.bing.com/th/id/R.9d116f4b200ab906fc0a232f496f2812?rik=yVowSf2vOH7kDQ&pid=ImgRaw&r=0");
